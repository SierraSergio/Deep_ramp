...
#añadido por mi con otra capa de upsampling
def _unet_896(n_classes, encoder, l1_skip_conn=True, input_height=416,
    ...
    #este bloque está copiado del último anterior al l1_skip para intentar que genera la máscara a 896px
    o = (UpSampling2D((2, 2), data_format=IMAGE_ORDERING))(o)
    #o = (concatenate([o, f2], axis=MERGE_AXIS))  es un skip, lo quito
    o = (ZeroPadding2D((1, 1), data_format=IMAGE_ORDERING))(o)
    o = (Conv2D(64, (3, 3), padding='valid' , activation='relu' , data_format=IMAGE_ORDERING))(o)  #64 filtros
    o = (BatchNormalization())(o)
...
def vgg_unet_896(n_classes, input_height=416, input_width=608, encoder_level=3):

    model = _unet_896(n_classes, get_vgg_encoder,
                  input_height=input_height, input_width=input_width)
    model.model_name = "vgg_unet_896"
    return model
...
def resnet50_unet_896(n_classes, input_height=896, input_width=896, encoder_level=3):

    model = _unet_896(n_classes, get_resnet50_encoder,
                  input_height=input_height, input_width=input_width)
    model.model_name = "resnet50_unet_896"
    return model
